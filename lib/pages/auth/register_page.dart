...
import 'package:flutter/material.dart'; // Tetap butuh untuk Colors & Icons tertentu jika perlu
...
class _RegisterPageState extends State<RegisterPage> {
  // Form Key tidak lagi dibutuhkan untuk CupertinoTextField manual check
  ...
  void _handleRegister() async {
    ...
    try {
      ...
      // Tampilkan dialog sukses ala Cupertino
      showCupertinoDialog(
        context: context,
        builder: (ctx) => CupertinoAlertDialog(
          title: const Text('Berhasil'),
          content: const Text('Registrasi Berhasil! Silakan Login untuk melengkapi data.'),
          actions: [
            CupertinoDialogAction(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "Daftar sekarang untuk mengakses layanan Muhammadiyah App",
                  style: TextStyle(
